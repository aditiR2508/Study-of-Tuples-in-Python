...
## Tuple elements are accessed using index numbers, starting from 0. Both:
### •	Positive indexing
### •	Negative indexing are supported.
________________________________________
## 6. Slicing in Tuples
## Slicing is used to extract a portion of a tuple.
## General Syntax: tuple_name[start : end : step]
...
### List---> Mutable--> Uses: [ ]--> Slower--> Dynamic
### Tuple---> Immutable--> Uses: ( )--> Faster--> Fixed

# Conclusion
## In this experiment, Python tuples were studied and operations such as creation, indexing, slicing, packing, unpacking, and built-in functions were successfully implemented.
